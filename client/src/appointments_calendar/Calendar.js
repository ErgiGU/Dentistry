                        ...
                        <div id="selectClinic" className="col-lg-12 col-md-12 mb-4">
                            <Card>
                                <Card.Body>
                                    ...
                                    <input type="radio" value="YourDentist" name="clinicName"
                                           onClick={handleClick}/> Your Dentist&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="ToothFairy" name="clinicName"/> Tooth
                                    Fairy&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="TheCrown" name="clinicName"/> The Crown&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="LisebergDentist" name="clinicName"/> Liseberg
                                    Dentist&nbsp;&nbsp;&nbsp;
                                </Card.Body>
                            </Card>
                        </div>
